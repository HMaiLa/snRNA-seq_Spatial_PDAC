...
```{r load_sce_object}
qc.dbl.fltrd.sts.sce <- readRDS("~/Projects/PDAC_STS_2024/data/qc.dbl.fltrd.sts.sce.RDS")
...
library(clustree)
clustree::clustree(sts.seurat) #very stable clustering at 0.4, 0.7, 0.8, 1.0

Idents(sts.seurat) <- "SCT_snn_res.0.5"
sts.seurat$seurat_clusters <- NULL
sts.seurat$seurat_clusters <- sts.seurat$SCT_snn_res.0.5 # see analysis below, this resolution works very well
...
marker.sets <- list(Malignant_PDAC = c("KRT19","MUC1","KRT17","ACTN4","LMO7"),
                    Malignant_Acinar = c("CPA1","CPA2","PRSS1","RBPJL","CEL"), # "SPINK1","GATM"
                    ...
                    T_Cells = c("CD3D","CD3E","CD96","CD2","CD247"), #revised
